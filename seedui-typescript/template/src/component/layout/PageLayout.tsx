    ...
    const firstNavList: NavItem[] = [
        {
            ...
            title: 'Dashboard',
            icon: <Dashboard />,
            onClick: (): void => { setActive('dashboard'); window.location.href = '/dashboard' },
            divider: false,
        },
        {
            itemID: 'inviteUser',
            title: 'Invite User',
            icon: <GroupAdd />,
            onClick: (): void => { setActive('inviteUser'); window.location.href = '/invite' },
            divider: false,
        }
    ]
            ...
            <Drawer open={open} width={332} variant="persistent" activeItem={active}>
                ...
                <DrawerFooter>
                    ...
                    <div style={{ paddingLeft: 18, display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <Typography sx={copyRightsStyle()} variant="caption">© Copyright 2023 Eaton.</Typography>
                    </div>
